...
def get_m2m_text(title, field):
    ...
    def inner(self, obj=None, is_header=None, *args, **kwargs):
        ...
        value_list = [str(row) for row in queryset]
...
class StarkHandler(object):
    ...
    def display_edit_del(self, obj=None, is_header=None, *args, **kwargs):
        if is_header:
            return '操作'
        tpl = "<a href='%s' class='btn btn-warning btn-xs'>编辑</a> <a href='%s' class='btn btn-warning btn-xs'>删除</a>" % (
    ...
    def get_update_btn(self, request, *args, **kwargs):
        ...
        if self.has_update_btn:
            return "<a class='btn btn-primary' href='%s' target='_blank'>下载在港船舶动态</a>" % self.reverse_commens_url(
                'update',
                *args, **kwargs)
        return None

    has_update_today_btn = False
    ...
    def save(self, form, request, is_update, *args, **kwargs):
        ...
        :param request:
        :param form:
        :param is_update:   以后可以借此函数进行更改函数的了内容的条件
        :return:
        """
        form.save()
    ...
    # 生成返回的url，带参数
    def reverse_commens_url(self, name, *args, **kwargs):
    ...
    def reverse_add_url(self, *args, **kwargs):
        ...
        :return:
        """
        return self.reverse_commens_url(self.get_add_url_name, *args, **kwargs)
    ...
    def reverse_change_url(self, *args, **kwargs):
        ...
        :return:
        """
        return self.reverse_commens_url(self.get_change_url_name, *args, **kwargs)
    ...
    def reverse_delete_url(self, *args, **kwargs):
        ...
        :return:
        """
        return self.reverse_commens_url(self.get_delete_url_name, *args, **kwargs)
